            ...
            {jerseys.map((jersey) => (
              ...
              >
                <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                  <img className="object-cover" src={jersey.image} alt={jersey.title} />
                ...
                <div className="mt-4 px-5 pb-5">
                  <a href="#">
                    <h5 className="text-xl tracking-tight text-slate-900">{jersey.title}</h5>
                  </a>
                  <div className="mt-2 mb-5 flex items-center justify-between">
                    <p>
                      <span className="text-3xl font-bold text-slate-900">{jersey.price}</span>
                      <span className="text-sm text-slate-900 line-through">{jersey.originalPrice}</span>
                    </p>
